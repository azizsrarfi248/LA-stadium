...
export default function Home() {
  return (
    <>
      ...
      <main>
        {/*carousel*/}
        <div className="carousel w-full mt-[80px] h-[600px]">
        ...
        <div className="flex justify-center w-full py-2 gap-2">
          <a href="#item1" className="btn-primary btn-xs btn-outline">
            1
          </a>
          <a href="#item2" className="btn-primary btn-xs btn-outline">
            2
          </a>
          <a href="#item3" className="btn-primary btn-xs btn-outline">
            3
          </a>
        </div>
        {/*more specific*/}
        ...
        {/*footer*/}
        <footer className="footer p-10 bg-lime-300 text-neutral-content">
          <div>
            <svg
              width="50"
              height="10"
